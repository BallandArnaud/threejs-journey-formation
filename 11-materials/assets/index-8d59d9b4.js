...
`+pf(i.getShaderSource(e),o)}else return r}function gf(i,e){const t=mf(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function _f(i,e){let t;switch(e){case hl:t="Linear";break;case ul:t="Reinhard";break;case dl:t="OptimizedCineon";break;case fl:t="ACESFilmic";break;case pl:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function vf(i){return[i.extensionDerivatives||i.envMapCubeUVHeight||i.bumpMap||i.normalMapTangentSpace||i.clearcoatNormalMap||i.flatShading||i.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(i.extensionFragDepth||i.logarithmicDepthBuffer)&&i.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",i.extensionDrawBuffers&&i.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(i.extensionShaderTextureLOD||i.envMap||i.transmission)&&i.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(mi).join(`
`)}function xf(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function Mf(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function mi(i){return i!==""}function Oa(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Ba(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Ef=/^[ \t]*#include +<([\w\d./]+)>/gm;function as(i){return i.replace(Ef,yf)}const Sf=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function yf(i,e){let t=Ie[e];if(t===void 0){const n=Sf.get(e);if(n!==void 0)t=Ie[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return as(t)}const Tf=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function za(i){return i.replace(Tf,bf)}function bf(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Ha(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function Af(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Ka?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Bo?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Qt&&(e="SHADOWMAP_TYPE_VSM"),e}function wf(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ii:case ri:e="ENVMAP_TYPE_CUBE";break;case fr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Rf(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ri:e="ENVMAP_MODE_REFRACTION";break}return e}function Cf(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Za:e="ENVMAP_BLENDING_MULTIPLY";break;case ll:e="ENVMAP_BLENDING_MIX";break;case cl:e="ENVMAP_BLENDING_ADD";break}return e}function Lf(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Pf(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=Af(t),c=wf(t),h=Rf(t),d=Cf(t),f=Lf(t),m=t.isWebGL2?"":vf(t),_=xf(s),v=r.createProgram();let p,u,S=t.glslVersion?"#version "+t.glslVersion+`
...
`;continue}if((k=F.match(y))&&(C.gamma=parseFloat(k[1])),(k=F.match(V))&&(C.exposure=parseFloat(k[1])),(k=F.match(q))&&(C.valid|=2,C.format=k[1]),(k=F.match(j))&&(C.valid|=4,C.height=parseInt(k[1],10),C.width=parseInt(k[2],10)),C.valid&2&&C.valid&4)break}return C.valid&2||o(3,"missing format specifier"),C.valid&4||o(3,"missing image size specifier"),C},m=function(I,x,y){const V=x;if(V<8||V>32767||I[0]!==2||I[1]!==2||I[2]&128)return new Uint8Array(I);V!==(I[2]<<8|I[3])&&o(3,"wrong scanline width");const q=new Uint8Array(4*x*y);q.length||o(4,"unable to allocate buffer space");let j=0,C=0;const F=4*V,k=new Uint8Array(4),Y=new Uint8Array(F);let ee=y;for(;ee>0&&C<I.byteLength;){C+4>I.byteLength&&o(1),k[0]=I[C++],k[1]=I[C++],k[2]=I[C++],k[3]=I[C++],(k[0]!=2||k[1]!=2||(k[2]<<8|k[3])!=V)&&o(3,"bad rgbe scanline format");let Z=0,$;for(;Z<F&&C<I.byteLength;){$=I[C++];const z=$>128;if(z&&($-=128),($===0||Z+$>F)&&o(3,"bad scanline data"),z){const ae=I[C++];for(let he=0;he<$;he++)Y[Z++]=ae}else Y.set(I.subarray(C,C+$),Z),Z+=$,C+=$}const D=V;for(let z=0;z<D;z++){let ae=0;q[j]=Y[z+ae],ae+=V,q[j+1]=Y[z+ae],ae+=V,q[j+2]=Y[z+ae],ae+=V,q[j+3]=Y[z+ae],j+=4}ee--}return q},_=function(I,x,y,V){const q=I[x+3],j=Math.pow(2,q-128)/255;y[V+0]=I[x+0]*j,y[V+1]=I[x+1]*j,y[V+2]=I[x+2]*j,y[V+3]=1},v=function(I,x,y,V){const q=I[x+3],j=Math.pow(2,q-128)/255;y[V+0]=Gi.toHalfFloat(Math.min(I[x+0]*j,65504)),y[V+1]=Gi.toHalfFloat(Math.min(I[x+1]*j,65504)),y[V+2]=Gi.toHalfFloat(Math.min(I[x+2]*j,65504)),y[V+3]=Gi.toHalfFloat(1)},p=new Uint8Array(e);p.pos=0;const u=f(p),S=u.width,E=u.height,b=m(p.subarray(p.pos),S,E);let w,L,A;switch(this.type){case Bt:A=b.length/4;const I=new Float32Array(A*4);for(let y=0;y<A;y++)_(b,y*4,I,y*4);w=I,L=Bt;break;case nn:A=b.length/4;const x=new Uint16Array(A*4);for(let y=0;y<A;y++)v(b,y*4,x,y*4);w=x,L=nn;break;default:throw new Error("THREE.RGBELoader: Unsupported type: "+this.type)}return{width:S,height:E,data:w,header:u.string,gamma:u.gamma,exposure:u.exposure,type:L}}setDataType(e){return this.type=e,this}load(e,t,n,r){function s(o,a){switch(o.type){case Bt:case nn:o.colorSpace=Xt,o.minFilter=ct,o.magFilter=ct,o.generateMipmaps=!1,o.flipY=!0;break}t&&t(o,a)}return super.load(e,s,n,r)}}const Ri=new Dp,Ro=document.querySelector("canvas.webgl"),Si=new ap,Vt={width:window.innerWidth,height:window.innerHeight},an=new gp,Ip=an.load("./textures/door/color.jpg");an.load("./textures/door/alpha.jpg");an.load("./textures/door/ambientOcclusion.jpg");an.load("./textures/door/height.jpg");an.load("./textures/door/normal.jpg");an.load("./textures/door/metalness.jpg");an.load("./textures/door/roughness.jpg");const Np=an.load("./textures/matcaps/1.png");an.load("./textures/gradients/3.jpg");Ip.colorSpace=tt;Np.colorSpace=tt;const Rt=new cp;Rt.metalness=0;Rt.roughness=0;Ri.add(Rt,"metalness").min(0).max(1).step(1e-4);Ri.add(Rt,"roughness").min(0).max(1).step(1e-4);Rt.transmission=1;Rt.ior=1.5;Rt.thickness=.5;Ri.add(Rt,"transmission").min(0).max(1).step(1e-4);Ri.add(Rt,"ior").min(1).max(10).step(1e-4);Ri.add(Rt,"thickness").min(0).max(1).step(1e-4);const ur=new zt(new ms(.5,32,32),Rt);ur.position.x=-1.5;const ls=new zt(new gr(1,1,50,50),Rt),dr=new zt(new gs(.3,.2,64,128),Rt);dr.position.x=1.5;Si.add(ur,ls,dr);const Fp=new Up;Fp.load("./textures/environmentMap/2k.hdr",i=>{i.mapping=rr,Si.background=i,Si.environment=i});window.addEventListener("resize",()=>{Vt.width=window.innerWidth,Vt.height=window.innerHeight,vn.aspect=Vt.width/Vt.height,vn.updateProjectionMatrix(),yi.setSize(Vt.width,Vt.height),yi.setPixelRatio(Math.min(window.devicePixelRatio,2))});const vn=new Pt(75,Vt.width/Vt.height,.1,100);vn.position.x=1;vn.position.y=1;vn.position.z=2;Si.add(vn);const Co=new xp(vn,Ro);Co.enableDamping=!0;const yi=new wo({canvas:Ro});yi.setSize(Vt.width,Vt.height);yi.setPixelRatio(Math.min(window.devicePixelRatio,2));const Op=new _p,Lo=()=>{const i=Op.getElapsedTime();ur.rotation.y=.1*i,ls.rotation.y=.1*i,dr.rotation.y=.1*i,ur.rotation.x=-.15*i,ls.rotation.x=-.15*i,dr.rotation.x=-.15*i,Co.update(),yi.render(Si,vn),window.requestAnimationFrame(Lo)};Lo();
//# sourceMappingURL=index-8d59d9b4.js.map
